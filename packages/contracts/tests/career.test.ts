...
describe('CareerSave', () => {
  ...
  it('requires schemaVersion', () => {
    expect(() => CareerSaveSchema.parse({
      player: {}, world: {}, context: {}, relationships: {}, story: {}, ledger: [], randomState: {},
    })).toThrow();
  });
    ...
    const withOpportunity = {
      ...
      context: {
        ...
        pendingOpportunity: {
          week: 3,
          offers: [
            { id: 'local', academyId: 'shanghai-根宝', academyName: '根宝青训基地', pathway: 'local-academy', riskLabel: 'low', description: '本地青训营' },
            { id: 'school', academyId: 'shanghai-校园', academyName: '上海校园精英计划', pathway: 'school-elite', riskLabel: 'medium', description: '校园足球计划' },
          ],
        },
      },
    };
